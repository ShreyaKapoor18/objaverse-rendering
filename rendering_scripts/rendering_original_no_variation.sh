...
script_name="rendering_original_no_variation.sh"
num_items=${#items[@]}
blender_cmd="blender -b -P scripts_custom/blender_script_2_no_variation.py"
...
function render_item {
    ...
    echo "blender -b -P scripts_custom/blender_script_2_no_variation.py -- --object_path "$item" --output_dir jsons/original_fixedangles $render_options"
    blender -b -P scripts_custom/blender_script_2_no_variation.py -- --object_path "$item" --output_dir jsons/original_fixedangles $render_options
}
iteration_count=0
