...
function render_item {
    ...
    blender -b -P scripts_custom/blender_script_2_less_variation.py -- --object_path "$item" --output_dir /Users/shreya/Documents/GitHub/objaverse-rendering/original_less_variation $render_options
}
iteration_count=0
