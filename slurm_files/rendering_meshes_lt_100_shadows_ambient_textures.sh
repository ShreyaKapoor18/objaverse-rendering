...
gpu_indices=(0)
mapfile -t -n 50 items < "$WORK/objaverse-rendering/jsons/input_models_path_lt_100_remaining_meshes_lt_100_shadows_ambient_textures.txt"
...
function render_item {
    ...
    --object_path "$item" --output_dir ~/git/objaverse-rendering/meshes_lt_100_shadows_ambient_textures $render_options
}
