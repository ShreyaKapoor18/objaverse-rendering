...
def add_background_image(list_env_maps, i):
    ...
    # Make sure the object has a mesh (skip lamps, cameras, etc.)
        if obj.type == 'MESH':
            # Assign the emission material to the object
        ...
        # Set emission color and strength for the object to illuminate itself
