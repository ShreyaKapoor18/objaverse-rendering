...
def add_background_image(list_env_maps, i):
   ...
   # bpy.data.objects['Cube'].select_set(True)
    ...
    image_path = "PATH_TO_YOUR_HDRI_IMAGE"  # Replace with your HDRI image path
    image_tex_node.image = bpy.data.images.load(image_path)
    ...
    mat.node_tree.links.new(image_tex_node.outputs['Color'], background_node.inputs['Color'])
    mat.node_tree.links.new(background_node.outputs['Background'], output_node.inputs['Surface'])
