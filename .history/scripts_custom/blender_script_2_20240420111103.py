...
def add_background_image(list_env_maps, i):
    ...
    for obj in bpy.context.selected_objects:
        ...
        bounding_box_center = obj.location  # Use object's location instead of bounding box center

        # Add hemisphere at bounding box center
        radius_multiplier = 20  # Adjust the multiplier as needed
        bpy.ops.mesh.primitive_uv_sphere_add(radius=radius_multiplier, location=(bounding_box_center.x, bounding_box_center.y, bounding_box_center.z + 5))  # Upper hemisphere sphere
        bpy.ops.mesh.primitive_uv_sphere_add(radius=radius_multiplier, location=(bounding_box_center.x, bounding_box_center.y, bounding_box_center.z - 5))  # Lower hemisphere sphere
        ...
        emission_strength = 3  # Adjust strength as needed
        ...
        # Adjust shadow settings for the hemisphere light
