...
for obj in mesh_objects:
    ...
    gradient_texture_node = emission_mat.node_tree.nodes.new(type='ShaderNodeTexGradient')
    ...
    emission_mat.node_tree.links.new(mapping_node.outputs['Vector'], gradient_texture_node.inputs['Vector'])
    emission_mat.node_tree.links.new(gradient_texture_node.outputs['Color'], color_ramp_node.inputs['Fac'])
    emission_mat.node_tree.links.new(color_ramp_node.outputs['Color'], emission_node.inputs['Color'])
    emission_mat.node_tree.links.new(color_ramp_node.outputs['Color'], principled_bsdf_node.inputs['Base Color'])
    emission_mat.node_tree.links.new(principled_bsdf_node.outputs['BSDF'], output_node.inputs['Surface'])
