...
def calculate_bounding_box_center():
...
def add_background_image(list_env_maps, i):
    ...
    for obj in bpy.context.selected_objects:
        ...
        bounding_box_center, min_corner, max_corner = calculate_bounding_box_center()
        ...
        coordinates = []
        for _ in range(5):
            coord_x = np.random.uniform(min_corner[0], max_corner[0])
            coord_y = np.random.uniform(min_corner[1], max_corner[1])
            coord_z = np.random.uniform(min_corner[2], max_corner[2])
        ...
        # Add UV sphere
            ...
            emission_strength = 2000  # Adjust strength as needed
        ...
        bpy.context.scene.world.light_settings.use_ambient_occlusion = True # scene will look brighter

        # Set Ambient Occlusion Strength
        #bpy.context.scene.world.light_settings.ao_factor = 1.0  # Adjust as needed
