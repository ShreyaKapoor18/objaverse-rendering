...
def add_background_map(list_env_maps, i):
    ...
    # Create or retrieve the Background node
    backNode = nodes.get('Background')
    if backNode is None:
        backNode = nodes.new("ShaderNodeBackground")
        backNode.location = (-200, 0)

    # Position the Environment Texture node
    envNode = nodes.new("ShaderNodeTexEnvironment")
    envNode.location = (-400, 0)
    ...
    world.light_settings.environment_energy = 1.0  # Adjust as needed
