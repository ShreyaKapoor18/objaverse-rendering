...
# Iterate over each mesh object
    for obj in mesh_objects:
        ...
        if obj.active_material:
            # Create a new emission material for each object
            emission_mat = bpy.data.materials.new(name="Emission_" + obj.name)
            ...
            # Connect nodes
            emission_mat.node_tree.links.new(color_ramp_node.outputs[0], emission_node.inputs['Strength'])
            ...
            for node in active_material.node_tree.nodes:
                ...
                if node.type == 'TEX_IMAGE':
                    ...
                    emission_mat.node_tree.links.new(image_texture_node.outputs['Generated'], color_ramp_node.inputs['Color'])
