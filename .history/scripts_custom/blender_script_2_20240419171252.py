...
# Load environment map (HDRI) as world background
hdri_path = "PATH_TO_YOUR_HDRI_IMAGE"  # Replace with the path to your HDRI image
...
# Connect nodes
world.node_tree.links.new(tex_coord_node.outputs['Generated'], mapping_node.inputs['Vector'])
world.node_tree.links.new(mapping_node.outputs['Vector'], env_tex_node.inputs['Vector'])
world.node_tree.links.new(env_tex_node.outputs['Color'], bg_node.inputs['Color'])

# Adjust world settings
world.world_volume.density = 0  # Ensure no volumetric effects
