...
for obj in bpy.context.selected_objects:
    ...
    bpy.context.scene.world.light_settings.ao_factor = 0.5  # Adjust as needed
    
    emission_material = bpy.data.materials.new(name="AmbientLightMaterial")
    ...
    obj = bpy.context.object  # Get the active object or select an object
    if obj is not None:
        obj.data.materials.clear()  # Clear existing materials
        obj.data.materials.append(emission_material)  # Assign
