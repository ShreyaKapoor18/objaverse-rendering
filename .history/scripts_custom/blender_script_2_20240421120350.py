...
def calculate_bounding_box_corners(obj):
    ...
    # Get the object's bounding box vectors
    bounding_box_vectors = obj.bound_box
    
    # Transform the bounding box vectors to world space
    bounding_box_corners_world = [world_matrix @ obj.matrix_local @ vector for vector in bounding_box_vectors]
