...
def add_background_image(list_env_maps, i):
    ...
    # Add UV Map node to select the active UV map
    uv_map_node = emission_mat.node_tree.nodes.new(type='ShaderNodeUVMap')
    uv_map_node.uv_map = "UVMap"  # Replace "UVMap" with the name of your UV map if necessary
    ...
    # Connect Emission node to Material Output node
    emission_mat.node_tree.links.new(emission_node.outputs[0], output_node.inputs[0])
