...
def add_background_image(list_env_maps, i):
    ...
    imageNode.image = bpy.data.images.load(image_path)

    # Connect Image Texture node to Background node
    imageNode.location.x = backNode.location.x - 300
    imageNode.location.y = backNode.location.y
    imageNodeColorOut = imageNode.outputs['Color']
    backColIn = backNode.inputs['Color']
    links.new(imageNodeColorOut, backColIn)
...
def add_ambient_illumination(intensity):
    ...
    bpy.data.worlds["World"].node_tree.nodes["Background"].inputs[0].default_value = (0.827564, 0.827564, 0.827564, 1)
            ...
            # Remove links to the Metallic input
                for link in mat.node_tree.links:
                        if link.to_node == principled_bsdf.inputs["Metallic"]:
                            ...
                            pruncipled_bsdf.inputs["Metallic"].default_value = 0
...
if __name__ == "__main__":
    try:
        ...
        #/Users/shreya/Desktop/rigged_mid_poly_horse.glb
        #/Users/shreya/Desktop/broken_steampunk_clock.glb
        #/Users/shreya/Desktop/tritonen-_und_najadenbrunnen.glb
        #/Users/shreya/Desktop/grabfigur.glb
        #/Users/shreya/Desktop/the_invincible.glb
