...
for obj in bpy.context.selected_objects:
    ...
    # Add UV sphere
        ...
        # Add emission material to the sphere
        ...
        sphere.data.materials.append(hemisphere_material)
        
        # Add point light at sphere's location
        bpy.ops.object.light_add(type='POINT', location=(pair[0], pair[1], pair[2]))
        light = bpy.context.object
        
        # Adjust light settings
        light.data.energy = 100  # Adjust brightness as needed
        light.data.use_shadow = True  # Enable shadow casting for more realistic lighting
        
        # Parent the light to the sphere so it moves with the sphere
        light.parent = sphere
        
        # Set the light color (optional)
        light.data.color = (1, 1, 1)  # White light (adjust as needed)
