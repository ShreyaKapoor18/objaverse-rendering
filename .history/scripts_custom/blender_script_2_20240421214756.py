...
def add_background_image(list_env_maps, i):
    ...
    background_node.location = 0, 0  # Position the node in the editor

    # Set ambient lighting color and strength
    ambient_light_color = (0.5, 0.5, 0.5, 1.0)  # RGB color
    ambient_light_strength = 1.0  # Strength

    background_node.inputs[0].default_value = ambient_light_color
    background_node.inputs[1].default_value = ambient_light_strength
