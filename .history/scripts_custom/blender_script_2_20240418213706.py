...
# Add Ambient Occlusion node for ambient lighting
ambient_occlusion_node = bpy.context.scene.world.node_tree.nodes.new(type='ShaderNodeAmbientOcclusion')

# Add Mix Shader node to combine environment texture and ambient occlusion
...
links.new(env_tex_node.outputs[0], mix_shader_node.inputs[1])
links.new(ambient_occlusion_node.outputs[1], mix_shader_node.inputs[2])
