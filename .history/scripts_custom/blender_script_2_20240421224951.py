...
def add_background_image(list_env_maps, i):
    ...
    # Add Geometry node to access mesh attributes
    geom_node = emission_mat.node_tree.nodes.new(type='ShaderNodeGeometry')

    # Add emission node
    emission_node = emission_mat.node_tree.nodes.new(type='ShaderNodeEmission')

    # Connect Texture Coordinate node to Emission node
