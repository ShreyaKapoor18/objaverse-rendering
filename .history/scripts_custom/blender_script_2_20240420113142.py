...
def add_background_image(list_env_maps, i):
    ...
    for obj in bpy.context.selected_objects:
        ...
        for pair in pairs:
            result = tuple(x * y for x, y in zip(pair, tuple2))

            bpy.ops.mesh.primitive_uv_sphere_add(radius=radius_multiplier, location=pair*(bounding_box_center.x, bounding_box_center.y, bounding_box_center.z))  # Upper hemisphere sphere
