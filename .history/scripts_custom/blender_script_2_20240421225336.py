...
# Connect UV coordinates to Emission node
emission_mat.node_tree.links.new(tex_coord_node.outputs[2], emission_node.inputs[0])  # Use UV coordinates
...
emission_mat.node_tree.links.new(emission_node.outputs[0], output_node.inputs[0])
    ...
    # Select objects of type "MESH"
    for obj in bpy.data.objects:
        if obj.type == 'MESH':
            obj.select_set(True)
    selected_objects = bpy.context.selected_objects
    print(selected_objects)
    # Get the mesh object you want to illuminate itself (replace 'Cube' with the name of your object)
