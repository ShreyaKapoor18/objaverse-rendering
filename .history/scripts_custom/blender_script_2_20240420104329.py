...
def add_background_image(list_env_maps, i):
    ...
    for obj in bpy.context.selected_objects:
        ...
        bpy.ops.mesh.primitive_uv_sphere_add(radius=1, location=(bounding_box_center.x, bounding_box_center.y, bounding_box_center.z + 5))  # Upper hemisphere sphere
        bpy.ops.mesh.primitive_uv_sphere_add(radius=1, location=(bounding_box_center.x, bounding_box_center.y, bounding_box_center.z - 5))  # Lower hemisphere sphere
