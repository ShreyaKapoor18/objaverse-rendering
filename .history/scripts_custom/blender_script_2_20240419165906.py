...
def add_background_image(list_env_maps, i):
    ...
    #bpy.ops.uv.unwrap(method='SPHERE_PROJECT')
    bpy.ops.object.mode_set(mode='OBJECT')
    ...
    emission_node.inputs['Color'].default_value = (1, 1, 1)  # White color
    ...
    light.data.color = (1, 1, 1, 1)  # Adjust the color of the light source as needed
