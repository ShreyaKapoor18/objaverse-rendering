...
def add_background_image(list_env_maps, i):
    ...
    bpy.ops.mesh.primitive_plane_add(size=100)  # Adjust the size as needed
    ...
    # Position the plane to cover the scene
    plane.location = (-20, -20, -20)  # Adjust the Z position as needed
