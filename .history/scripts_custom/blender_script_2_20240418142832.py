...
def add_background_image(list_env_maps, i, intensity):
...
def add_ambient_illumination(list_env_maps, i, intensity):
    ...
    # Clear existing nodes
    if 'Environment Texture' in world.node_tree.nodes:
        env_tex_node = world.node_tree.nodes['Environment Texture']
    else:
        env_tex_node = world.node_tree.nodes.new('ShaderNodeTexEnvironment')
        env_tex_node.location = (-200, 0)
    print(list_env_maps[i])
