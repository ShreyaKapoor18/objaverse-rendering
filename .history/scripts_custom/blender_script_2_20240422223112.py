    ...
    for obj in bpy.data.objects:
        ...
        for material_slot in obj.material_slots:
            ...
            # Clear existing nodes in the material's node tree
                ...
                # Connect Image Texture node to Emission node
                material.node_tree.links.new(image_texture_node.outputs['Color'], emission_node.inputs['Color'])
                ...
                material.node_tree.links.new(emission_node.outputs['Emission'], material_output_node)
