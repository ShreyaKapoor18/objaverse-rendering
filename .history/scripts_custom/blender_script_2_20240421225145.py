...
def add_background_image(list_env_maps, i):
    ...
    # Add Attribute node to access UV coordinates
    uv_node = emission_mat.node_tree.nodes.new(type='ShaderNodeAttribute')
    uv_node.attribute_name = "UV"

    # Add emission node
    emission_node = emission_mat.node_tree.nodes.new(type='ShaderNodeEmission')

    # Connect UV coordinates to Emission node
    emission_mat.node_tree.links.new(uv_node.outputs[0], emission_node.inputs[0])
