...
#SBATCH --export=NONE
#SBATCH -o ./slurm_files/output/rendering_original_wo_all.out
#SBATCH -e ./slurm_files/errors/rendering_original_wo_all.err
unset SLURM_EXPORT_ENV
export SSL_CERT_DIR=/etc/ssl/certs
export SSL_CERT_FILE=/etc/ssl/cert.pem
input_file=/Users/shreya/Documents/GitHub/objaverse-rendering/jsons/input_models_path_lt_100.txt
items=()  # Initialize the items array
mapfile -t items < /Users/shreya/Documents/GitHub/objaverse-rendering/jsons/input_models_path_lt_100.txt
...
export CUDA_VISIBLE_DEVICES=0
# Print the contents of the array
>>>>>>> 6058f5a60b2fc2c356b0e2deed3ee15bdd91785f
...
function render_item {
    ...
    echo "blender -b -P scripts_custom/blender_script_2.py -- --object_path "$item" --output_dir jsons/original_wo_all_2024-04-17_10-41-19 $render_options"
    blender -b -P scripts_custom/blender_script_2.py -- --object_path "$item" --output_dir jsons/original_wo_all_2024-04-17_10-41-19 $render_options
}
iteration_count=0
for item in "${items[@]}"; do
