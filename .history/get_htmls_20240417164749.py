...
folder_names = os.listdir('/Users/shreya/git/objaverse-rendering/jsons')

for directory in folder_names:
    print(directory)
    # Specify the directory you want to list the folders for
    directory_path = f"/Users/shreya/git/objaverse-rendering/{directory}/"
    ...
    directory_path_2 = f"/Users/shreya/git/objaverse-rendering/{directory}/original"
...
html_table += "<tr>"
folder_names_out = ['ambient_ill', 'wo_all', 'z_axis', 'less_variation', 'no_variation_axis']
...
for j in range(num_folders):
    ...
    folder_path = f"/Users/shreya/git/objaverse-rendering/{folder}/"
...
max_images = max([len(file_paths[j]) for j in range(num_folders)])
print('***'*20)
print(max_images)    
for i in range(max_images):
    ...
    for j in range(num_folders):
        ...
        try:
            ...
            image_path = '/Users/shreya/sshfs-mounts/File-Disqus_d_icon_official_-_white_on_transparent_background.png.html'
        #print(image_path)
        # Read and encode the image to base64
        with open(image_path, "rb") as image_file:
            base64_image = base64.b64encode(image_file.read()).decode("utf-8")
            # Embed each image in a cell of the table
            html_table += f"""<td><figure><img src="data:image/jpeg;base64,{base64_image}" alt="{image_path}"><center><figcaption><b>{folder_names_out[j]}</b></figcaption></center></figure><br><br></td>"""
    html_table += "</tr>"   
html_table += "</table>"
#print(html_table)
